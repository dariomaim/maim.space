	...
	<body <?php body_class(); ?>>
		...
		<div class="wrapper">
		   ...
		   <div class="subtitular">		
			  ...
			  <h5><?php echo single_cat_title("", false); ?></h5>
                        ...
                        if ( get_post_type() == 'post' ) : ?>
                            ...
                            <div class="meta">
                                ...
                                <p>
                                    ...
                                    <a href="#" title="<?php the_title_attribute(); ?>"><?php the_time( get_option( 'date_format' ) ); ?></a>
                                 <?php 
									///
									//
									/* No meta right now 
                                ...
                                <?php if ( is_singular( 'post' ) ) : ?>
                                    ...
                                    <p><?php _e( 'en', 'davis' ); ?> <?php the_category( ', ' ); ?></p>
                                    <p><?php the_tags( ' #', ' #', ' ' ); ?></p>
            ...
            if ( ( ! is_singular() ) && ( $wp_query->post_count >= get_option( 'posts_per_page' ) ) ) : ?>
		        ...
		        <div class="pagination">
					...
					<?php previous_posts_link( '&larr; ' . __( 'más Nuevos', 'davis' ) ); ?>
					<?php next_posts_link( __( 'más Antigüos', 'davis') . ' &rarr;' ); ?>
	        ...
	        <footer>
		        ...
		        <p><?php echo date( 'Y' ); ?></p>
		        <p><a href="uncopyright">uncopyright</a></p>
